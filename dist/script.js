...
function loadData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const [productsRes, categoriesRes] = yield Promise.all([
            ...
            const productsData = yield productsRes.json();
            const categoriesData = yield categoriesRes.json();
...
function goToPage(page, event) {
    ...
    const query = ((_b = (_a = document.getElementById('search-input')) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '';
    const filtered = query
        ? allProducts.filter(p => {
            var _a, _b;
            return p.title.toLowerCase().includes(query) ||
                p.category.name.toLowerCase().includes(query) ||
                ((_b = (_a = p.brand) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(query));
        })
        : allProducts;
    renderProducts(filtered);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!p || p.id !== id) {
                ...
                const res = yield fetch(`https://ecommerce.routemisr.com/api/v1/products/${id}`);
                if (!res.ok)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[60px] items-start">
        ...
        <div>
          ...
          <p class="text-sm text-[#555]">Brand: <strong>${((_a = p.brand) === null || _a === void 0 ? void 0 : _a.name) || 'N/A'}</strong></p>
        </div>
